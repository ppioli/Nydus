...
public interface IPersistence<TTo>
{
    ...
    /// </summary>
    /// <remarks>
    ///     Uses <see cref="AutoMapper.EquivalencyExpression.EquivalentExpressions.GenerateEquality" />> to find equality
    ///     between Source and From Types to determine if insert or update
    /// </remarks>
