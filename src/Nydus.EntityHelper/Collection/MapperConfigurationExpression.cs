...
{
    /// <summary>
    ///     Generates and adds property maps based on the primary keys for the given <see cref="DbContext" />. This is done by
    ///     creating an
    ...
    ///     Generates and adds property maps based on the primary keys for the given <see cref="DbContext" />. This is done by
    ///     resolving an
    ///     instance of the <see cref="DbContext" /> using a temporary <see cref="IServiceProvider" /> based on the
    ///     <see cref="IServiceCollection" />.
    ///     This method is generally called from <see cref="IServiceCollection" />.AddAutoMapper().
    /// </summary>
    public static void UseEntityFrameworkCoreModel<TContext>(
    ...
    ///     Generates and adds property maps based on the primary keys for the given <see cref="DbContext" />. This is done by
    ///     resolving an
    ///     instance of the <see cref="DbContext" /> using the <see cref="IServiceProvider" />. This method is generally used
    ...
    /// <summary>
    ///     Generates and adds property maps based on the primary keys for the given <see cref="DbContext" />. This method is
    ///     generally
